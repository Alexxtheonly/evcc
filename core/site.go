...
type Site struct {
	...
	heatingDegreeCached    func() (heatingDegreeResult, error) // util.Cached wrapper around queryHeatingDegreeFit
}
...
func NewSite() *Site {
	...
	site.heatingDegreeCached = util.Cached(site.queryHeatingDegreeFit, 24*time.Hour)
