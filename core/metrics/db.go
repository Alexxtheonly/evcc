...
type meter struct {
	...
	Incomplete   bool     `json:"incomplete,omitempty" gorm:"column:incomplete"` // a reading feeding this slot failed, excluded from profile
}
...
func persist(entity entity, ts time.Time, energy, returnEnergy float64, socTemp *float64, recovered, incomplete bool) error {
