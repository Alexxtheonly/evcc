...
// TestUpdateAdaptivePlanRefreshesStableButAgingPlan is the repeating-plan counterpart to
// TestUpdateExpectedArrivalRefreshesStableButAgingPrediction: SetAdaptivePlans is the only
